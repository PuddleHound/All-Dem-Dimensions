...
public class WorldGenSkyCherryTree extends WorldGenTreeBase
{

    public WorldGenSkyCherryTree()
    {
    }
				...
				for(int k1 = -1; k1 < 3; k1++)
				{
					for(int l1 = -1; l1 < 2; l1++)
					{
						if(random.nextInt(2) == 0 && !world.getBlock(j2 + j1, k2 + k1, l2 + l1).getMaterial().isSolid())
						{
							...
							{
								setBlockAndNotifyAdequately(world, j2 + j1, k2 + k1 - 1, l2 + l1, AllDemDimensions.skyFruit, AllDemDimensions.skyFruit.CHERRY);
							}
						}
					}
				}
